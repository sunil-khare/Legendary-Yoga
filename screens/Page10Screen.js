...
var db;
export default class Page10Screen extends React.Component {
    constructor(props) {
        super(props)
            ...
            <View style={style.container} onTouchEnd={() => {
                ...
                <SafeAreaView style={{ flex: 1 }}>
                    <View style={{ display: this.state.display }}>
                        <TouchableOpacity style={style.butonViewLeft} onPress={() => this.props.navigation.navigate('Credits')}>
                            <MaterialIcons name="chevron-left" size={30} color="white"></MaterialIcons>
                        </TouchableOpacity>
                        <TouchableOpacity style={style.butonViewRight} onPress={() => this.props.navigation.navigate('Behind the Scenes')}>
                        ...
                        <View>
                            <View style={{ flex: 1, alignItems: "center" }}>
                                ...
                                <Text style={style.textView}>
                                    {"\t\t\t"} The Author is always open to hearing praise and/or constructive criticism about the book and you can funnel all that to this email: <Text style={{ fontWeight: "bold" }}>LEGENDSOFYOGA@gmail.com </Text>
                                Also if you would like to book a Legends of Yoga active Storytelling Workshop/Event at your studio the author is also open to that and can be reached at{"\n"}<Text style={{ fontWeight: "bold" }}>LEGENDSOFYOGA@gmail.com </Text> {"\n\n"}
